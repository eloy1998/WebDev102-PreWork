# WebDev102-PreWork
# Android Prework - *Temp Prework*

Submitted by: **Eloy Beaucejour**

**Temp Prework** is an android app that shows an image and introductory message, and allows pressing a button to display a Toast. 
